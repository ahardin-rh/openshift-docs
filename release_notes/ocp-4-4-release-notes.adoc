...
makes the the CNO fatal, which is a violation of RFC 3986. As a result, CNO was
...
`apiVersion` is updated to to `v1`.
...
* The web console downloads deployment will fail on nodes configured with `ipv6.disable=1`.
 (link:it https://bugzilla.redhat.com/show_bug.cgi?id=1795325[*BZ1795325*])
...
[[rhba-2020-1581]]
=== RHBA-2020:1581 - {product-title} 4.4 Image release and bug fix advisory
...
link:https://access.redhat.com/errata/RHBA-2020:1581[RHBA-2020:1581] advisory.
The RPM packages included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:1582[RHBA-2020:1582] advisory.
